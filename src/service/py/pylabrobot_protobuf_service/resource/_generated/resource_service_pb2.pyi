...
class TipData(_message.Message):
  ...
  def __init__(
    ...
    tip_size: _Optional[str] = ...,
    pickup_method: _Optional[str] = ...,
  ) -> None: ...
...
class ResourceData(_message.Message):
  ...
  def __init__(
    ...
    name: _Optional[str] = ...,
    type: _Optional[str] = ...,
    size_x: _Optional[float] = ...,
    size_y: _Optional[float] = ...,
    size_z: _Optional[float] = ...,
    category: _Optional[str] = ...,
    model: _Optional[str] = ...,
    location: _Optional[_Union[Coordinate, _Mapping]] = ...,
    rotation: _Optional[_Union[Rotation, _Mapping]] = ...,
    parent_name: _Optional[str] = ...,
    material_z_thickness: _Optional[float] = ...,
    max_volume: _Optional[float] = ...,
    well_bottom_type: _Optional[str] = ...,
    cross_section_type: _Optional[str] = ...,
    plate_type: _Optional[str] = ...,
    has_lid: bool = ...,
    prototype_tip: _Optional[_Union[TipData, _Mapping]] = ...,
    ordering: _Optional[_Mapping[str, str]] = ...,
    nesting_z_height: _Optional[float] = ...,
  ) -> None: ...
...
class ResourceTree(_message.Message):
  ...
  def __init__(
    self,
    data: _Optional[_Union[ResourceData, _Mapping]] = ...,
    children: _Optional[_Iterable[_Union[ResourceTree, _Mapping]]] = ...,
  ) -> None: ...
...
class VolumeTrackerState(_message.Message):
  ...
  def __init__(
    ...
    pending_volume: _Optional[float] = ...,
    max_volume: _Optional[float] = ...,
    is_disabled: bool = ...,
  ) -> None: ...
...
class GetLocationWrtRequest(_message.Message):
  ...
  def __init__(
    ...
    other_name: _Optional[str] = ...,
    anchor_x: _Optional[str] = ...,
    anchor_y: _Optional[str] = ...,
    anchor_z: _Optional[str] = ...,
  ) -> None: ...
...
class BatchGetLocationWrtRequest(_message.Message):
  ...
  def __init__(
    self, items: _Optional[_Iterable[_Union[LocationWrtItem, _Mapping]]] = ...
  ) -> None: ...
...
class BatchCoordinateResponse(_message.Message):
  ...
  def __init__(
    self, coordinates: _Optional[_Iterable[_Union[Coordinate, _Mapping]]] = ...
  ) -> None: ...
...
class ComputeVolumeHeightRequest(_message.Message):
  ...
  value: float
  def __init__(
    self, resource_name: _Optional[str] = ..., value: _Optional[float] = ...
  ) -> None: ...
...
class TrackerOpRequest(_message.Message):
  ...
  volume: float
  def __init__(
    self, resource_name: _Optional[str] = ..., volume: _Optional[float] = ...
  ) -> None: ...
...
class BatchTrackerOpRequest(_message.Message):
  ...
  def __init__(
    self, ops: _Optional[_Iterable[_Union[TrackerOpRequest, _Mapping]]] = ...
  ) -> None: ...
